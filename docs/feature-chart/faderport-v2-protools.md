...
=== "Channel Strip"
    ...
    | Arm | `Shift`+ | Toggles record arm for all tracks. |
    ...
    | Knob Button | `Shift`+ | Resets Pan Position to Center. |
    | Fader Touch | `Shift`+ | Resets Fader position to 0. |
...
=== "Automation"
    ...
    | Touch | `Shift`+ | Enables Latch Mode Automation for the selected Channel. |
    | Write |  | Enables Write Mode Automation for the selected Channel. |
    | Write | `Shift`+ | Toggles Trim Mode Automation for the selected Channel. |
    | Read |  | Enables Automation selection. Hold down button to make selection using 2 different methods. |
    | Read | `Shift`+ | Enables Off Mode Automation for the selected Channel. |
...
=== "Bank Mode With Fader Flip"
    ...
    | Section | `Shift`+ | Assigns Send D to knob. |
...
=== "Utility"
    ...
    | Utility |  |  |
    |---|---|---|
    | Prev | `Shift`+ | Undo the last action. |
    | Next | `Shift`+ | Redo the last action. |
    | Master | `Shift`+ | Toggles between Mix/Edit window. |
